...
class BenzaTrackerApp(ttk.Frame):
    ...
    def _build_kpi_panel(self) -> None:
        ...
        kpi_frame.grid(row=3, column=0, sticky="ew", padx=20, pady=(0, 10))
    ...
    def _build_chart(self) -> None:
        chart_frame = ttk.LabelFrame(self, text="Spesa mensile")
        chart_frame.grid(row=5, column=0, sticky="nsew", padx=20, pady=(0, 20))
